...
usuarioRouter.get("/usuarios/:id", Auth.autenticacao, Auth.permissao, UsuarioController.readOne)
usuarioRouter.post("/usuarios", verificaCamposMiddleware("nome", "email", "senha"), UsuarioController.insert)
usuarioRouter.put("/usuarios/:id", Auth.autenticacao, Auth.permissao, UsuarioController.update)
usuarioRouter.delete("/usuarios/:id", Auth.autenticacao, Auth.permissao, UsuarioController.delete)
